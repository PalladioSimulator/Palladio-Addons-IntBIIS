...
public class ResourceFactory {
    ...
    public static SimActiveResource createActiveResource(final EventSimModel model,
        ...
        String resourceName;
        if (schedulingPolicy.equals(SchedulingPolicy.FCFS)) {
        ...
        } else if (schedulingPolicy.equals(SchedulingPolicy.DELAY)) {
        ...
        } else if (schedulingPolicy.equals(SchedulingPolicy.PROCESSOR_SHARING)) {
            ...
            resource = model.getSchedulingFactory().createResourceFromExtension(specification.getSchedulingPolicy().getId(),
                    getNextResourceId(), numberOfReplicas);
            if (resource == null) {
     ...
     * 
     */
    public static SimPassiveResource createDeviceResource(final EventSimModel model,
        ...
        IPassiveResource schedulerResource = new SimSimpleFairPassiveResource(model, capacity, name, resourceId,
                null, combinedId, SIMULATE_FAILURES);
