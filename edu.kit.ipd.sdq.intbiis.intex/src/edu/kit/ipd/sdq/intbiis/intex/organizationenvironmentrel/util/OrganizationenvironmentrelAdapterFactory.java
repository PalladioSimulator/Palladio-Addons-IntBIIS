 ...
 * @generated
 */
public class OrganizationenvironmentrelAdapterFactory extends AdapterFactoryImpl {
	/**
	 ...
	 * @generated
	 */
	public OrganizationenvironmentrelAdapterFactory() {
	 ...
	 * @generated
	 */
	protected OrganizationenvironmentrelSwitch<Adapter> modelSwitch =
		new OrganizationenvironmentrelSwitch<Adapter>() {
			@Override
			public Adapter caseDeviceResourceRel(DeviceResourceRel object) {
				return createDeviceResourceRelAdapter();
			}
			@Override
			public Adapter caseRoleRel(RoleRel object) {
				return createRoleRelAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link edu.kit.ipd.sdq.intbiis.intex.organizationenvironmentrel.DeviceResourceRel <em>Device Resource Rel</em>}'.
	 * <!-- begin-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createDeviceResourceRelAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link edu.kit.ipd.sdq.intbiis.intex.organizationenvironmentrel.RoleRel <em>Role Rel</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createRoleRelAdapter() {
		return null;
	}
...
} //OrganizationenvironmentrelAdapterFactory
