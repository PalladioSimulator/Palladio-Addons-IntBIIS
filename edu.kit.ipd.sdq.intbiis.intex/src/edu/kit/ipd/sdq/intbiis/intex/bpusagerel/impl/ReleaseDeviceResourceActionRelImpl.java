...
import de.uhd.ifi.se.pcm.bppcm.bpusagemodel.impl.ReleaseDeviceResourceActionImpl;
...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Release Device Resource Action Rel</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link edu.kit.ipd.sdq.intbiis.intex.bpusagerel.impl.ReleaseDeviceResourceActionRelImpl#getFailureProbability <em>Failure Probability</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ReleaseDeviceResourceActionRelImpl extends ReleaseDeviceResourceActionImpl implements ReleaseDeviceResourceActionRel {
	/**
	 ...
	 * @generated
	 */
	protected ReleaseDeviceResourceActionRelImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return BpusagerelPackage.Literals.RELEASE_DEVICE_RESOURCE_ACTION_REL;
	}
	...
	public void setFailureProbability(double newFailureProbability) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BpusagerelPackage.RELEASE_DEVICE_RESOURCE_ACTION_REL__FAILURE_PROBABILITY, oldFailureProbability, failureProbability));
	}
...
} //ReleaseDeviceResourceActionRelImpl
