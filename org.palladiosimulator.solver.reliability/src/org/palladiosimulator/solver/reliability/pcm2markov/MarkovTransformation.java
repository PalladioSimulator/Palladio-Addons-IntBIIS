...
import intex.solver.bp2markov.BusinessProcessVisitor;
import intex.solver.bp2markov.MarkovBusinessProcessVisitor;
...
public class MarkovTransformation {
    ...
    private void runDSolver(final UsageScenario scenario, final MarkovTransformationSource markovSource) {
         ...
         * Sonjas changes:
         */
        BusinessProcessVisitor visitor = new BusinessProcessVisitor(markovSource.getModel());
    ...
    private void runPcm2MarkovSingle(final PCMSolverWorkflowRunConfiguration configuration,
         ...
         * Sonjas changes:
         */
        MarkovBusinessProcessVisitor visitor = new MarkovBusinessProcessVisitor(markovSource, getEvaluationMode(configuration),
        		!configuration.isIterationOverPhysicalSystemStatesEnabled(), configuration.isMarkovModelReductionEnabled(),
        		configuration.isMarkovModelTracesEnabled());
