...
public class IntBIISResourceFactory {
     ...
     * 
     */
    public static IntBIISSimDeviceResource createDeviceResource(final EventSimModel model,
        ...
        IPassiveResource schedulerResource = new IntBIISSimSimpleFairPassiveDeviceResource(specification, model, capacity, name, combinedId);



        return new IntBIISSimDeviceResource(model, schedulerResource, specification);
    }
